...
const ServiceCard = ({ title, children }) => (
  <div className="bg-white/10 rounded-lg p-3 md:p-6 flex flex-col items-center justify-center text-center">
    <h3 className="text-base md:text-2xl font-semibold mb-1 md:mb-2">{title}</h3>
    {children}
  </div>
);
    ...
    <div className="h-screen md:snap-y md:snap-mandatory overflow-y-auto">
      ...
      <section className="min-h-screen md:h-screen md:snap-start relative bg-black">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 pt-20 pb-16 md:py-0">
          ...
          />
          <h1 className="text-4xl md:text-6xl font-bold mb-4 text-white">UNSWMSA</h1>
          <p className="text-lg md:text-xl mb-8 text-white">FOR STUDENTS, BY STUDENTS</p>
          <button className="border-2 border-white text-white px-6 py-2 md:px-8 md:py-3 text-base md:text-lg hover:bg-white hover:text-black transition-colors">
            JOIN TODAY
          </button>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-24">
            ...
            <div className="flex flex-col justify-center space-y-4 md:space-y-8 order-1 md:order-2">
              ...
              <p className="text-base md:text-xl font-light leading-relaxed">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean eget suscipit nunc.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="min-h-screen md:h-screen md:snap-start bg-[#C84C29] text-white py-16 md:py-0">
        <div className="max-w-6xl mx-auto h-full px-4 md:px-16 flex flex-col justify-center">
          <h2 className="text-2xl md:text-5xl font-bold mb-8">On campus we offer...</h2>
      ...
      <section className="min-h-screen md:h-screen md:snap-start bg-[#F4A261] text-white py-16 md:py-0">
        <div className="max-w-6xl mx-auto h-full px-4 md:px-16 flex flex-col justify-center">
          <div className="flex flex-col">
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-8">...and events aplenty</h2>
